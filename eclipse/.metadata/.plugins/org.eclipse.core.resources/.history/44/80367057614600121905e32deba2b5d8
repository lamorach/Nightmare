...
import nightmareRealm.client.core.items.BlockNmOre;
...
//loads the mod
	...
	SoulshadeBlock= (new BlockNmOre(201, 1)).setHardness(5.0F).setResistance(20.0F).setStepSound(Block.soundStoneFootstep).setBlockName("oreSoulshade").setTextureFile("/nmGFX/blocks.png");
	NightshadeBlock= (new BlockNmOre(202, 2)).setHardness(5.0F).setResistance(20.0F).setStepSound(Block.soundStoneFootstep).setBlockName("oreNightshade").setTextureFile("/nmGFX/blocks.png");
	EmbershadeBlock= (new BlockNmOre(203, 3)).setHardness(5.0F).setResistance(20.0F).setStepSound(Block.soundStoneFootstep).setBlockName("oreEmbershade").setTextureFile("/nmGFX/blocks.png");
	...
	GameRegistry.addRecipe(new ItemStack(nightmareRealm.NightshadeSword, 1), new Object[] { " X ", " X ", "I", Character.valueOf('X'), nightmareRealm.NightshadeOre, Character.valueOf('I'),Item.stick});
	GameRegistry.addRecipe(new ItemStack(nightmareRealm.SoulshadeSword, 1), new Object[] { " X ", " X ", "I", Character.valueOf('X'), nightmareRealm.SoulshadeOre, Character.valueOf('I'),Item.stick});
	GameRegistry.addRecipe(new ItemStack(nightmareRealm.EmbershadeSword, 1), new Object[] { " X ", " X ", "I", Character.valueOf('X'), nightmareRealm.EmbershadeOre, Character.valueOf('I'),Item.stick});
