package nightmareRealm.client.core.blocks;
...
public class BlockEmberTorch extends Block
{
	public BlockEmberTorch(int par1, int par2)
    {
        super(par1, par2, Material.circuits); //this makes it a torch like block
        this.setTickRandomly(true);
        this.setCreativeTab(CreativeTabs.tabDecorations); //this puts it in the decoration tabw
    }
   ...
   //this is a check to prevent placing it on glass. if you click on glass it will check all other directions for a placement
    ...
    {
    	((EntityLiving) par5EntityPlayer).addPotionEffect(new PotionEffect(Potion.fireResistance.getId(), 2500, 3));
		((EntityLiving) par5EntityPlayer).addPotionEffect(new PotionEffect(Potion.regeneration.getId(), 2500, 1));
        return true;
    }
